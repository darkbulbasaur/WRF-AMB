...
CONTAINS
   ...
   SUBROUTINE surface_driver(                                         &
     ...
     &          ,smcrel                                               &
     &          ,th10,th2,thz0,th_phy,tmn,tshltr,tsk,TSK0,tslb        & 
     ...
     &          ,scm_force_skintemp,scm_force_flux,t2,emiss,EMISS0           & 
   ...
   REAL, DIMENSION( ims:ime, jms:jme ) , INTENT(INOUT)::   TSK, TSK0 
   ...
   REAL, DIMENSION( ims:ime, jms:jme ), OPTIONAL, INTENT(INOUT)::   emiss, EMISS0 
  ...
  real,    optional,  dimension(ims:ime,1:maxpatch,jms:jme ),intent(inout) ::  &
   ...
   REAL, OPTIONAL, DIMENSION( ims:ime, jms:jme ), INTENT(INOUT) :: CHC_SFCDIF
     ...
     REAL, OPTIONAL, DIMENSION( ims:ime, jms:jme ), INTENT(INOUT)  :: URBVEG2D  
...
'Lack arguments to call lsm_mosaic')
	  ...
	  ELSEIF (sf_surface_mosaic == 0) THEN
               ...
               CALL lsm(dz8w,qv_curr,p8w,t_phy,tsk, TSK0,       & 
                hfx,qfx,lh,grdflx,qgh,gsw,swdown,glw,smstav,smstot,    &
                sfcrunoff,udrunoff,ivgtyp,isltyp,isurban,isice,vegfra,        &
       ...
       DO j=j_start(ij),j_end(ij)                             
         DO i=i_start(ij),i_end(ij)                           
          IF( IVGTYP(I,J) == ISURBAN .or. IVGTYP(I,J) == 31 .or. &  
            ...
            U10(I,J)  = U_phy(I,1,J)                       
            V10(I,J)  = V_phy(I,1,J)                       
			CALL WRF_DEBUG(200,'TJ bep line 3330') 
           END IF                                             
         ENDDO                                                
       ENDDO                                                  
     ENDIF
